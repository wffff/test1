 ...
 */
@Entity
@Table(name = "t_vendor_order_product")
public class VendorOrderProductEntity extends AbstractEntity {
    @Id
    ...
    public VendorOrderProductEntity() {
    }

    public VendorOrderProductEntity(Integer vid, Integer orderid, Integer vorderid, String name, String aname, String vpname, String vaname, String model, String amodel, String vmodel, String vamodel, String spec, String ASpec, String vspec, String vASpec, Double price, Double priceOriginal, String deliverydate, Double number, Integer quote_id, String pro_name, String fromDispath, Double freight, String brand, String unit, String specname, String memo) {
        this.vid = vid;
    ...
    public String toString() {
        return "VendorOrderProductEntity{" +
                "id=" + id +
                ", vid=" + vid +
                ", orderid=" + orderid +
                ", vorderid=" + vorderid +
