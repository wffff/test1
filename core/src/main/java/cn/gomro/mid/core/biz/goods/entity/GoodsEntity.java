...
public class GoodsEntity extends AbstractEntity {
    ...
    @OneToMany(targetEntity = GoodsModelEntity.class,cascade = CascadeType.ALL,fetch = FetchType.EAGER,mappedBy = "goods")
    private List<GoodsModelEntity> GoodsModelList = new ArrayList<>();

    public GoodsEntity() {
    }

    public GoodsEntity(GoodsType type, String images, GoodsBrandEntity brand, GoodsCategoryEntityWithOutTree category, String hscode,String unspsc,String name, String tags, Double priceMin, Double priceMax, Integer sales, Integer views, Boolean saled, String packages, String technology, String description, String memo, Boolean del, Date last, Date time) {
        this.type = type;
        this.images = images;
        this.brand = brand;
    ...
    public List<GoodsModelEntity> getGoodsModelList() {
        return GoodsModelList;
    }

    public void setGoodsModelList(List<GoodsModelEntity> goodsModelList) {
